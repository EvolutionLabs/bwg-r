									...
									<div class="container">
										<div class="filter-controls">
											<div class="btn-group clear separate">
												<a href="#filters-all" class="btn btn-sm btn-secondary btn-outline btn-default">Select all</a>
												<a href="#filters-none" class="btn btn-sm btn-secondary btn-outline btn-default">Select none</a>
												<a href="#filters-inverse" class="btn btn-sm btn-secondary btn-outline btn-default">Invert selection</a>
											</div>
