		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<p>To change header bckground color, change <code>bg-success</code> to <code>bg-warning</code>,
					<code>bg-primary</code>, <code>bg-danger</code>, <code>bg-info</code> or remove it (for white
					background).
				</p>
			</div>
		...
		<div class="col-md-9 col-sm-12 col-main">
					...
					<div class="flexRow">
						<div class="flexCol">
							...
							<div class="btn-group clear separate">
								...
								<a href="#" class="btn btn-danger" data-toggle="modal" data-target="#deleteCartModal">Erase
									Cart</a>
								<a href="#" class="btn btn-default btn-outline" data-toggle="modal"
								   data-target="#updateCartModal">Update
									Cart</a>
							</div>
						</div>
			...
			<div class="card padding">
				...
				<div class="alert alert-danger" role="alert">
					...
					<p>This is a default danger alert. You could use <label
							class="label label-success">.alert-success</label>,
						...
						<label class="label label-warning">.alert-warning</label> and <label
							class="label label-default">.alert-default</label>.
					</p>
